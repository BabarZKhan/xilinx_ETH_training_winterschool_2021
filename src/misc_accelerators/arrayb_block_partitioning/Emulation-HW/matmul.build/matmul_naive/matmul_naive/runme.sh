...
HD_PWD='/home/centos/workspace/arrayb_block_partitioning/Emulation-HW/matmul.build/matmul_naive/matmul_naive'
cd "$HD_PWD"
...
EAStep vitis_hls -f matmul_naive.tcl -messageDb vitis_hls.pb

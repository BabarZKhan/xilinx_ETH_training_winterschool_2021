...
typedef struct {
    ...
    XMatmul_naive_uio_map maps[ MAX_UIO_MAPS ];
} XMatmul_naive_uio_info;

/***************** Variable Definitions **************************************/
static XMatmul_naive_uio_info uio_info;
...
static int uio_info_read_name(XMatmul_naive_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XMatmul_naive_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XMatmul_naive_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XMatmul_naive_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XMatmul_naive_Initialize(XMatmul_naive *InstancePtr, const char* InstanceName) {
	XMatmul_naive_uio_info *InfoPtr = &uio_info;

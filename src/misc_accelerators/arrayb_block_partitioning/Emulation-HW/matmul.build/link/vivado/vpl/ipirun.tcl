...
set vpl_output_dir "/home/centos/workspace/arrayb_block_partitioning/Emulation-HW/matmul.build/link/int"
set input_dir "input"
set steps_log "../../link.steps.log"
set kernel_ip_dirs {
  {/home/centos/workspace/arrayb_block_partitioning/Emulation-HW/matmul.build/link/int/xo/ip_repo/xilinx_com_hls_matmul_partition_1_0}
  {/home/centos/workspace/arrayb_block_partitioning/Emulation-HW/matmul.build/link/int/xo/ip_repo/xilinx_com_hls_matmul_naive_1_0}}
...
set config_info [dict create \
  ...
  kernels                  "matmul_naive matmul_partition" \
  steps_log                 $steps_log \
  impl_from_step           "" \
  impl_to_step             "" \
  num_jobs                  4 \
  ...
  no_ip_cache               false \
  remote_ip_cache          "/home/centos/workspace/arrayb_block_partitioning/Emulation-HW/.ipcache" \
  user_board_repo           {} \
  user_bconn                {} \
  ...
  aie_archive_file         "/home/centos/workspace/arrayb_block_partitioning/Emulation-HW/matmul.build/link/int/system.aieprj" \
...
set exec_profile_matmul_partition_1 [dict create \
  port matmul_partition_1 \
  option all \
];
set data_profile_matmul_naive_1_M_AXI_GMEM [dict create \
  port matmul_naive_1/M_AXI_GMEM \
  option all \
];
set exec_profile_matmul_naive_1 [dict create \
  port matmul_naive_1 \
  option all \
];
set dict_profile [dict create \
  ...
  FIFO "8192" \
  DATA [list $data_profile_matmul_naive_1_M_AXI_GMEM] \
  STALL [list] \
  EXEC [list $exec_profile_matmul_partition_1 $exec_profile_matmul_naive_1] \

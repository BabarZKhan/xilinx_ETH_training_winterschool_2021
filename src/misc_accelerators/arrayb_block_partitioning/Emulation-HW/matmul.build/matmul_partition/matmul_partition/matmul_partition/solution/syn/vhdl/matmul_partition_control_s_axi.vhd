...
entity matmul_partition_control_s_axi is
generic (
...
end entity matmul_partition_control_s_axi;
...
architecture behave of matmul_partition_control_s_axi is
    ...
    constant ADDR_DIM_DATA_0   : INTEGER := 16#34#;
    constant ADDR_DIM_CTRL     : INTEGER := 16#38#;

...
HD_PWD='/home/centos/workspace/arrayb_block_partitioning/Emulation-HW/matmul.build/matmul_partition/matmul_partition'
cd "$HD_PWD"
...
EAStep vitis_hls -f matmul_partition.tcl -messageDb vitis_hls.pb

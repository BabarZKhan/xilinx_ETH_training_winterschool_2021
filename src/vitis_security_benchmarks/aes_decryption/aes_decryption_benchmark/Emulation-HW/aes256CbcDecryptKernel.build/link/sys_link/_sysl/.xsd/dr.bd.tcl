...
#---------------------------
# Instantiating aes256CbcDecryptKernel_1
#---------------------------
...
set_property -dict [ list  \
  CONFIG.SLR_ASSIGNMENTS {SLR0}  ] $aes256CbcDecryptKernel_1
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins -auto_enable /aes256CbcDecryptKernel_1/s_axi_control] \

connect_bd_net  \
  [get_bd_pins -auto_enable /kernel_clk/clk] \
  [get_bd_pins -auto_enable /slr0/interconnect_axilite_user_0/M01_ACLK] \
  [get_bd_pins -auto_enable /aes256CbcDecryptKernel_1/ap_clk] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /aes256CbcDecryptKernel_1/ap_rst_n] \
...
sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /aes256CbcDecryptKernel_1/m_axi_gmem0_0] \
  [get_bd_cells /memory_subsystem] [list M00_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /aes256CbcDecryptKernel_1/m_axi_gmem0_1] \

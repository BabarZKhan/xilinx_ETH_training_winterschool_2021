...
CONFIG.FREQ_HZ {100000000} \
  ...
  set ip [ create_bd_cell -type ip -vlnv xilinx.com:ip:sdx_memory_subsystem:1.0 ip ]
...
create_root_design ""
make_bd_intf_pins_external [get_bd_cells /ip]
make_bd_pins_external [get_bd_cells /ip]
assign_bd_addr

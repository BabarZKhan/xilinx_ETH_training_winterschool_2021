...
set vpl_output_dir "/home/centos/workspace/aes_decryption_benchmark/Emulation-HW/aes256CbcDecryptKernel.build/link/int"
set input_dir "input"
set steps_log "../../link.steps.log"
set kernel_ip_dirs {
  {/home/centos/workspace/aes_decryption_benchmark/Emulation-HW/aes256CbcDecryptKernel.build/link/int/xo/ip_repo/xilinx_com_hls_aes256CbcDecryptKernel_1_0}}
...
set config_info [dict create \
  ...
  run_script_map_file      "" \
  clbinary_name            "aes256CbcDecryptKernel" \
  kernels                  "aes256CbcDecryptKernel" \
  steps_log                 $steps_log \
  impl_from_step           "" \
  impl_to_step             "" \
  num_jobs                  4 \
  ...
  aie_archive_file         "/home/centos/workspace/aes_decryption_benchmark/Emulation-HW/aes256CbcDecryptKernel.build/link/int/system.aieprj" \
...
set data_profile_aes256CbcDecryptKernel_1_M_AXI_GMEM0_0 [dict create \
  port aes256CbcDecryptKernel_1/M_AXI_GMEM0_0 \
  option all \
];
set data_profile_aes256CbcDecryptKernel_1_M_AXI_GMEM0_1 [dict create \
  port aes256CbcDecryptKernel_1/M_AXI_GMEM0_1 \
  option all \
];
set exec_profile_aes256CbcDecryptKernel_1 [dict create \
  port aes256CbcDecryptKernel_1 \
  option all \
];
set dict_profile [dict create \
  NAME profile_monitors \
  FIFO "8192" \
  DATA [list $data_profile_aes256CbcDecryptKernel_1_M_AXI_GMEM0_0 $data_profile_aes256CbcDecryptKernel_1_M_AXI_GMEM0_1] \
  STALL [list] \
  EXEC [list $exec_profile_aes256CbcDecryptKernel_1] \

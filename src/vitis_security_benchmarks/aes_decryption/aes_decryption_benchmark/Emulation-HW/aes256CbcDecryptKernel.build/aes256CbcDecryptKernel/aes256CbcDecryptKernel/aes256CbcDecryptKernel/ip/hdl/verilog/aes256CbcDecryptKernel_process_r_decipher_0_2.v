...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module aes256CbcDecryptKernel_process_r_decipher_0_2_rom (
...
initial begin
    $readmemh("./aes256CbcDecryptKernel_process_r_decipher_0_2_rom.dat", ram0);
    $readmemh("./aes256CbcDecryptKernel_process_r_decipher_0_2_rom.dat", ram1);
    $readmemh("./aes256CbcDecryptKernel_process_r_decipher_0_2_rom.dat", ram2);
    $readmemh("./aes256CbcDecryptKernel_process_r_decipher_0_2_rom.dat", ram3);
    $readmemh("./aes256CbcDecryptKernel_process_r_decipher_0_2_rom.dat", ram4);
    $readmemh("./aes256CbcDecryptKernel_process_r_decipher_0_2_rom.dat", ram5);
    $readmemh("./aes256CbcDecryptKernel_process_r_decipher_0_2_rom.dat", ram6);
    $readmemh("./aes256CbcDecryptKernel_process_r_decipher_0_2_rom.dat", ram7);
end
...
`timescale 1 ns / 1 ps
module aes256CbcDecryptKernel_process_r_decipher_0_2(
    reset,
    clk,
    address0,
    ce0,
...
aes256CbcDecryptKernel_process_r_decipher_0_2_rom aes256CbcDecryptKernel_process_r_decipher_0_2_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

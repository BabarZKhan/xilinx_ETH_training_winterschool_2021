...
# FIFO definition:
set ID 120
set FifoName aes256CbcDecryptKernel_fifo_w64_d2_S
set InstName taskNum_c_U
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_taskNum \
    op interface \
    ports { taskNum { I 64 vector } taskNum_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_textInStrm \
    op interface \
    ports { textInStrm_dout { I 128 vector } textInStrm_empty_n { I 1 bit } textInStrm_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_endTextInStrm \
    op interface \
    ports { endTextInStrm_dout { I 1 bit } endTextInStrm_empty_n { I 1 bit } endTextInStrm_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_textOutStrm \
    op interface \
    ports { textOutStrm_din { O 128 vector } textOutStrm_full_n { I 1 bit } textOutStrm_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_endTextOutStrm \
    op interface \
    ports { endTextOutStrm_din { O 1 bit } endTextOutStrm_full_n { I 1 bit } endTextOutStrm_write { O 1 bit } } \
} "
}

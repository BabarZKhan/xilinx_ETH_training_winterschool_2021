...
entity aes256CbcDecryptKernel_singleCipherMode_256u_76 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of aes256CbcDecryptKernel_singleCipherMode_256u_76 is 
...
attribute shreg_extract : string;
    ...
    signal decipher_0_495_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal decipher_0_495_q1 : STD_LOGIC_VECTOR (31 downto 0);
    signal taskNum_blk_n : STD_LOGIC;
    signal IVStrm1_blk_n : STD_LOGIC;
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal cipherkeyStrm4_blk_n : STD_LOGIC;
    signal textInStrm7_blk_n : STD_LOGIC;
    signal ap_CS_fsm_pp0_stage0 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage0 : signal is "none";
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal e_5_reg_147 : STD_LOGIC_VECTOR (0 downto 0);
    signal endTextInStrm10_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal ap_phi_mux_e_5_phi_fu_150_p4 : STD_LOGIC_VECTOR (0 downto 0);
    signal textOutStrm13_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp0_iter15 : STD_LOGIC := '0';
    signal e_5_reg_147_pp0_iter14_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal endTextOutStrm16_blk_n : STD_LOGIC;
    signal ap_CS_fsm_state21 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state21 : signal is "none";
    signal e_5_reg_147_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal e_5_reg_147_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter4_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter5_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter6_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter7_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter8_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter9_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter10_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter11_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter12_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal e_5_reg_147_pp0_iter13_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal cipherkeyStrm4_read_reg_293 : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal tmp_5_reg_383 : STD_LOGIC_VECTOR (0 downto 0);
    signal textInStrm7_read_reg_388 : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter2_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter3_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter4_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter5_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter6_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter7_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter8_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter9_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter10_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter11_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter12_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter13_reg : STD_LOGIC_VECTOR (127 downto 0);
    signal textInStrm7_read_reg_388_pp0_iter14_reg : STD_LOGIC_VECTOR (127 downto 0);
...
begin
    decipher_0_495_U : component aes256CbcDecryptKernel_singleCipherMode_256u_75_decipher_0_496
    generic map (
        DataWidth => 32,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_phi_mux_e_5_phi_fu_150_p4 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((endTextInStrm10_empty_n = ap_const_logic_0) or (cipherkeyStrm4_empty_n = ap_const_logic_0) or (ap_const_logic_0 = IVStrm1_empty_n))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    e_5_reg_147_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((e_5_reg_147 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                e_5_reg_147 <= tmp_5_reg_383;
            elsif (((grp_updateKey_fu_192_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                e_5_reg_147 <= tmp_reg_303;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((endTextOutStrm16_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state21))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter15 = ap_const_logic_1))) then 
                p_load_04474_i_i_reg_157 <= textInStrm7_read_reg_388_pp0_iter14_reg;
            elsif (((grp_updateKey_fu_192_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((endTextInStrm10_empty_n = ap_const_logic_0) or (cipherkeyStrm4_empty_n = ap_const_logic_0) or (ap_const_logic_0 = IVStrm1_empty_n))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                IV_V_reg_298 <= IVStrm1_dout;
                cipherkeyStrm4_read_reg_293 <= cipherkeyStrm4_dout;
                tmp_reg_303 <= (0=>endTextInStrm10_dout, others=>'-');
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                e_5_reg_147_pp0_iter10_reg <= e_5_reg_147_pp0_iter9_reg;
                e_5_reg_147_pp0_iter11_reg <= e_5_reg_147_pp0_iter10_reg;
                e_5_reg_147_pp0_iter12_reg <= e_5_reg_147_pp0_iter11_reg;
                e_5_reg_147_pp0_iter13_reg <= e_5_reg_147_pp0_iter12_reg;
                e_5_reg_147_pp0_iter14_reg <= e_5_reg_147_pp0_iter13_reg;
                e_5_reg_147_pp0_iter2_reg <= e_5_reg_147_pp0_iter1_reg;
                e_5_reg_147_pp0_iter3_reg <= e_5_reg_147_pp0_iter2_reg;
                e_5_reg_147_pp0_iter4_reg <= e_5_reg_147_pp0_iter3_reg;
                e_5_reg_147_pp0_iter5_reg <= e_5_reg_147_pp0_iter4_reg;
                e_5_reg_147_pp0_iter6_reg <= e_5_reg_147_pp0_iter5_reg;
                e_5_reg_147_pp0_iter7_reg <= e_5_reg_147_pp0_iter6_reg;
                e_5_reg_147_pp0_iter8_reg <= e_5_reg_147_pp0_iter7_reg;
                e_5_reg_147_pp0_iter9_reg <= e_5_reg_147_pp0_iter8_reg;
                textInStrm7_read_reg_388_pp0_iter10_reg <= textInStrm7_read_reg_388_pp0_iter9_reg;
                textInStrm7_read_reg_388_pp0_iter11_reg <= textInStrm7_read_reg_388_pp0_iter10_reg;
                textInStrm7_read_reg_388_pp0_iter12_reg <= textInStrm7_read_reg_388_pp0_iter11_reg;
                textInStrm7_read_reg_388_pp0_iter13_reg <= textInStrm7_read_reg_388_pp0_iter12_reg;
                textInStrm7_read_reg_388_pp0_iter14_reg <= textInStrm7_read_reg_388_pp0_iter13_reg;
                textInStrm7_read_reg_388_pp0_iter2_reg <= textInStrm7_read_reg_388;
                textInStrm7_read_reg_388_pp0_iter3_reg <= textInStrm7_read_reg_388_pp0_iter2_reg;
                textInStrm7_read_reg_388_pp0_iter4_reg <= textInStrm7_read_reg_388_pp0_iter3_reg;
                textInStrm7_read_reg_388_pp0_iter5_reg <= textInStrm7_read_reg_388_pp0_iter4_reg;
                textInStrm7_read_reg_388_pp0_iter6_reg <= textInStrm7_read_reg_388_pp0_iter5_reg;
                textInStrm7_read_reg_388_pp0_iter7_reg <= textInStrm7_read_reg_388_pp0_iter6_reg;
                textInStrm7_read_reg_388_pp0_iter8_reg <= textInStrm7_read_reg_388_pp0_iter7_reg;
                textInStrm7_read_reg_388_pp0_iter9_reg <= textInStrm7_read_reg_388_pp0_iter8_reg;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                e_5_reg_147_pp0_iter1_reg <= e_5_reg_147;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((e_5_reg_147 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                textInStrm7_read_reg_388 <= textInStrm7_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_phi_mux_e_5_phi_fu_150_p4 = ap_const_lv1_0))) then
                tmp_5_reg_383 <= (0=>endTextInStrm10_dout, others=>'-');
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, taskNum_empty_n, IVStrm1_empty_n, cipherkeyStrm4_empty_n, endTextInStrm10_empty_n, endTextOutStrm16_full_n, ap_CS_fsm_state3, ap_CS_fsm_state21, ap_CS_fsm_state2, ap_CS_fsm_state4, grp_updateKey_fu_192_ap_done, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter13, ap_enable_reg_pp0_iter14, icmp_ln882_fu_202_p2)
    begin
        case ap_CS_fsm is
    ...
    IVStrm1_blk_n_assign_proc : process(IVStrm1_empty_n, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            IVStrm1_blk_n <= IVStrm1_empty_n;
        else 
            IVStrm1_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    IVStrm1_read_assign_proc : process(IVStrm1_empty_n, cipherkeyStrm4_empty_n, endTextInStrm10_empty_n, ap_CS_fsm_state3)
    begin
        if ((not(((endTextInStrm10_empty_n = ap_const_logic_0) or (cipherkeyStrm4_empty_n = ap_const_logic_0) or (ap_const_logic_0 = IVStrm1_empty_n))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            IVStrm1_read <= ap_const_logic_1;
        else 
            IVStrm1_read <= ap_const_logic_0;
        end if; 
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(textInStrm7_empty_n, endTextInStrm10_empty_n, textOutStrm13_full_n, endTextOutStrm16_full_n, ap_enable_reg_pp0_iter1, e_5_reg_147, ap_enable_reg_pp0_iter0, ap_phi_mux_e_5_phi_fu_150_p4, ap_enable_reg_pp0_iter15, e_5_reg_147_pp0_iter14_reg)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (endTextInStrm10_empty_n = ap_const_logic_0) and (ap_phi_mux_e_5_phi_fu_150_p4 = ap_const_lv1_0)) or ((e_5_reg_147 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (textInStrm7_empty_n = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter15 = ap_const_logic_1) and (((endTextOutStrm16_full_n = ap_const_logic_0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0)) or ((textOutStrm13_full_n = ap_const_logic_0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(textInStrm7_empty_n, endTextInStrm10_empty_n, textOutStrm13_full_n, endTextOutStrm16_full_n, ap_enable_reg_pp0_iter1, e_5_reg_147, ap_enable_reg_pp0_iter0, ap_phi_mux_e_5_phi_fu_150_p4, ap_enable_reg_pp0_iter15, e_5_reg_147_pp0_iter14_reg)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (endTextInStrm10_empty_n = ap_const_logic_0) and (ap_phi_mux_e_5_phi_fu_150_p4 = ap_const_lv1_0)) or ((e_5_reg_147 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (textInStrm7_empty_n = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter15 = ap_const_logic_1) and (((endTextOutStrm16_full_n = ap_const_logic_0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0)) or ((textOutStrm13_full_n = ap_const_logic_0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0)))));
    end process;


    ap_block_pp0_stage0_11001_ignoreCallOp90_assign_proc : process(textInStrm7_empty_n, endTextInStrm10_empty_n, textOutStrm13_full_n, endTextOutStrm16_full_n, ap_enable_reg_pp0_iter1, e_5_reg_147, ap_enable_reg_pp0_iter0, ap_phi_mux_e_5_phi_fu_150_p4, ap_enable_reg_pp0_iter15, e_5_reg_147_pp0_iter14_reg)
    begin
                ap_block_pp0_stage0_11001_ignoreCallOp90 <= (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (endTextInStrm10_empty_n = ap_const_logic_0) and (ap_phi_mux_e_5_phi_fu_150_p4 = ap_const_lv1_0)) or ((e_5_reg_147 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (textInStrm7_empty_n = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter15 = ap_const_logic_1) and (((endTextOutStrm16_full_n = ap_const_logic_0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0)) or ((textOutStrm13_full_n = ap_const_logic_0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(textInStrm7_empty_n, endTextInStrm10_empty_n, textOutStrm13_full_n, endTextOutStrm16_full_n, ap_enable_reg_pp0_iter1, e_5_reg_147, ap_enable_reg_pp0_iter0, ap_phi_mux_e_5_phi_fu_150_p4, ap_enable_reg_pp0_iter15, e_5_reg_147_pp0_iter14_reg)
    begin
    ...
    ap_block_state20_pp0_stage0_iter15_assign_proc : process(textOutStrm13_full_n, endTextOutStrm16_full_n, e_5_reg_147_pp0_iter14_reg)
    begin
                ap_block_state20_pp0_stage0_iter15 <= (((endTextOutStrm16_full_n = ap_const_logic_0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0)) or ((textOutStrm13_full_n = ap_const_logic_0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0)));
    end process;


    ap_block_state20_pp0_stage0_iter15_ignore_call3_assign_proc : process(textOutStrm13_full_n, endTextOutStrm16_full_n, e_5_reg_147_pp0_iter14_reg)
    begin
                ap_block_state20_pp0_stage0_iter15_ignore_call3 <= (((endTextOutStrm16_full_n = ap_const_logic_0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0)) or ((textOutStrm13_full_n = ap_const_logic_0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0)));
    end process;


    ap_block_state3_assign_proc : process(IVStrm1_empty_n, cipherkeyStrm4_empty_n, endTextInStrm10_empty_n)
    begin
                ap_block_state3 <= ((endTextInStrm10_empty_n = ap_const_logic_0) or (cipherkeyStrm4_empty_n = ap_const_logic_0) or (ap_const_logic_0 = IVStrm1_empty_n));
    end process;


    ap_block_state3_ignore_call13_assign_proc : process(IVStrm1_empty_n, cipherkeyStrm4_empty_n, endTextInStrm10_empty_n)
    begin
                ap_block_state3_ignore_call13 <= ((endTextInStrm10_empty_n = ap_const_logic_0) or (cipherkeyStrm4_empty_n = ap_const_logic_0) or (ap_const_logic_0 = IVStrm1_empty_n));
    end process;


    ap_block_state5_pp0_stage0_iter0_assign_proc : process(endTextInStrm10_empty_n, ap_phi_mux_e_5_phi_fu_150_p4)
    begin
                ap_block_state5_pp0_stage0_iter0 <= ((endTextInStrm10_empty_n = ap_const_logic_0) and (ap_phi_mux_e_5_phi_fu_150_p4 = ap_const_lv1_0));
    end process;


    ap_block_state5_pp0_stage0_iter0_ignore_call3_assign_proc : process(endTextInStrm10_empty_n, ap_phi_mux_e_5_phi_fu_150_p4)
    begin
                ap_block_state5_pp0_stage0_iter0_ignore_call3 <= ((endTextInStrm10_empty_n = ap_const_logic_0) and (ap_phi_mux_e_5_phi_fu_150_p4 = ap_const_lv1_0));
    end process;


    ap_block_state6_pp0_stage0_iter1_assign_proc : process(textInStrm7_empty_n, e_5_reg_147)
    begin
                ap_block_state6_pp0_stage0_iter1 <= ((e_5_reg_147 = ap_const_lv1_0) and (textInStrm7_empty_n = ap_const_logic_0));
    end process;


    ap_block_state6_pp0_stage0_iter1_ignore_call3_assign_proc : process(textInStrm7_empty_n, e_5_reg_147)
    begin
                ap_block_state6_pp0_stage0_iter1_ignore_call3 <= ((e_5_reg_147 = ap_const_lv1_0) and (textInStrm7_empty_n = ap_const_logic_0));
    end process;
    ...
    ap_condition_pp0_flush_enable_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_phi_mux_e_5_phi_fu_150_p4, ap_block_pp0_stage0_subdone)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_phi_mux_e_5_phi_fu_150_p4 = ap_const_lv1_1))) then 
    ...
    ap_int_blocking_cur_n <= (textOutStrm13_blk_n and textInStrm7_blk_n and taskNum_blk_n and endTextOutStrm16_blk_n and endTextInStrm10_blk_n and cipherkeyStrm4_blk_n and IVStrm1_blk_n);
    ...
    ap_phi_mux_e_5_phi_fu_150_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, e_5_reg_147, tmp_5_reg_383)
    begin
        if (((e_5_reg_147 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_phi_mux_e_5_phi_fu_150_p4 <= tmp_5_reg_383;
        else 
            ap_phi_mux_e_5_phi_fu_150_p4 <= e_5_reg_147;
        end if; 
    end process;
    ...
    cipherkeyStrm4_blk_n_assign_proc : process(cipherkeyStrm4_empty_n, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            cipherkeyStrm4_blk_n <= cipherkeyStrm4_empty_n;
        else 
            cipherkeyStrm4_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    cipherkeyStrm4_read_assign_proc : process(IVStrm1_empty_n, cipherkeyStrm4_empty_n, endTextInStrm10_empty_n, ap_CS_fsm_state3)
    begin
        if ((not(((endTextInStrm10_empty_n = ap_const_logic_0) or (cipherkeyStrm4_empty_n = ap_const_logic_0) or (ap_const_logic_0 = IVStrm1_empty_n))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            cipherkeyStrm4_read <= ap_const_logic_1;
        else 
            cipherkeyStrm4_read <= ap_const_logic_0;
        end if; 
    end process;


    endTextInStrm10_blk_n_assign_proc : process(endTextInStrm10_empty_n, ap_CS_fsm_state3, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter0, ap_phi_mux_e_5_phi_fu_150_p4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_phi_mux_e_5_phi_fu_150_p4 = ap_const_lv1_0)))) then 
            endTextInStrm10_blk_n <= endTextInStrm10_empty_n;
        else 
            endTextInStrm10_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    endTextInStrm10_read_assign_proc : process(IVStrm1_empty_n, cipherkeyStrm4_empty_n, endTextInStrm10_empty_n, ap_CS_fsm_state3, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_phi_mux_e_5_phi_fu_150_p4, ap_block_pp0_stage0_11001)
    begin
        if ((((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_phi_mux_e_5_phi_fu_150_p4 = ap_const_lv1_0)) or (not(((endTextInStrm10_empty_n = ap_const_logic_0) or (cipherkeyStrm4_empty_n = ap_const_logic_0) or (ap_const_logic_0 = IVStrm1_empty_n))) and (ap_const_logic_1 = ap_CS_fsm_state3)))) then 
            endTextInStrm10_read <= ap_const_logic_1;
        else 
            endTextInStrm10_read <= ap_const_logic_0;
        end if; 
    end process;


    endTextOutStrm16_blk_n_assign_proc : process(endTextOutStrm16_full_n, ap_block_pp0_stage0, ap_enable_reg_pp0_iter15, e_5_reg_147_pp0_iter14_reg, ap_CS_fsm_state21)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state21) or ((ap_const_boolean_0 = ap_block_pp0_stage0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter15 = ap_const_logic_1)))) then 
            endTextOutStrm16_blk_n <= endTextOutStrm16_full_n;
        else 
            endTextOutStrm16_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    endTextOutStrm16_din_assign_proc : process(endTextOutStrm16_full_n, ap_enable_reg_pp0_iter15, e_5_reg_147_pp0_iter14_reg, ap_CS_fsm_state21, ap_block_pp0_stage0_01001)
    begin
        if (((endTextOutStrm16_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state21))) then 
            endTextOutStrm16_din <= ap_const_logic_1;
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_01001) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter15 = ap_const_logic_1))) then 
            endTextOutStrm16_din <= ap_const_logic_0;
        else 
            endTextOutStrm16_din <= 'X';
        end if; 
    end process;


    endTextOutStrm16_write_assign_proc : process(endTextOutStrm16_full_n, ap_enable_reg_pp0_iter15, e_5_reg_147_pp0_iter14_reg, ap_CS_fsm_state21, ap_block_pp0_stage0_11001)
    begin
        if ((((endTextOutStrm16_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state21)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter15 = ap_const_logic_1)))) then 
            endTextOutStrm16_write <= ap_const_logic_1;
        else 
            endTextOutStrm16_write <= ap_const_logic_0;
        end if; 
    end process;
    ...
    textInStrm7_blk_n_assign_proc : process(textInStrm7_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, e_5_reg_147)
    begin
        if (((e_5_reg_147 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            textInStrm7_blk_n <= textInStrm7_empty_n;
        else 
            textInStrm7_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    textInStrm7_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, e_5_reg_147, ap_block_pp0_stage0_11001)
    begin
        if (((e_5_reg_147 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            textInStrm7_read <= ap_const_logic_1;
        else 
            textInStrm7_read <= ap_const_logic_0;
        end if; 
    end process;


    textOutStrm13_blk_n_assign_proc : process(textOutStrm13_full_n, ap_block_pp0_stage0, ap_enable_reg_pp0_iter15, e_5_reg_147_pp0_iter14_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter15 = ap_const_logic_1))) then 
            textOutStrm13_blk_n <= textOutStrm13_full_n;
        else 
            textOutStrm13_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    textOutStrm13_din <= (p_load_04474_i_i_reg_157 xor grp_process_r_fu_167_ap_return);

    textOutStrm13_write_assign_proc : process(ap_enable_reg_pp0_iter15, e_5_reg_147_pp0_iter14_reg, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (e_5_reg_147_pp0_iter14_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter15 = ap_const_logic_1))) then 
            textOutStrm13_write <= ap_const_logic_1;
        else 
            textOutStrm13_write <= ap_const_logic_0;
        end if; 
    end process;

...
set Library     "hls"
set IPName      "Adler32Kernel"
set Version     "1.0"
set DisplayName "Adler32kernel"
set Revision    "2101142155"
...
set xo_kernel_name "Adler32Kernel"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/centos/workspace/adler32_security_benchmark/Emulation-HW/Adler32Kernel.build/Adler32Kernel/Adler32Kernel/Adler32Kernel/solution"
set debug_dir "/home/centos/workspace/adler32_security_benchmark/Emulation-HW/Adler32Kernel.build/Adler32Kernel/Adler32Kernel/Adler32Kernel/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {Adler32Kernel_fifo_w32_d2_S
Adler32Kernel_fifo_w32_d5_S
Adler32Kernel_fifo_w32_d2_S
Adler32Kernel_fifo_w64_d2_S
Adler32Kernel_fifo_w64_d2_S
Adler32Kernel_fifo_w64_d2_S
Adler32Kernel_fifo_w64_d5_S
Adler32Kernel_fifo_w32_d16_S
Adler32Kernel_fifo_w32_d16_S
Adler32Kernel_fifo_w1_d16_S
Adler32Kernel_fifo_w512_d64_A
Adler32Kernel_fifo_w32_d2_S
Adler32Kernel_fifo_w128_d16_A
Adler32Kernel_fifo_w32_d16_S
Adler32Kernel_fifo_w1_d16_S
Adler32Kernel_start_for_writeS2M_U0
Adler32Kernel_start_for_adler32_16_U0
Adler32Kernel_start_for_splitStrm_U0
...
## Variables
set Top "Adler32Kernel"
set TopNoPrefix "Adler32Kernel"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 num W 0x0 "Data signal of num" {{0 32 num W 0 "Bit 31 to 0 of num"}}} {0x18 size W 0x0 "Data signal of size" {{0 32 size W 0 "Bit 31 to 0 of size"}}} {0x20 len_1 W 0x0 "Data signal of len" {{0 32 len W 0 "Bit 31 to 0 of len"}}} {0x24 len_2 W 0x0 "Data signal of len" {{0 32 len W 0 "Bit 63 to 32 of len"}}} {0x2c adler_1 W 0x0 "Data signal of adler" {{0 32 adler W 0 "Bit 31 to 0 of adler"}}} {0x30 adler_2 W 0x0 "Data signal of adler" {{0 32 adler W 0 "Bit 63 to 32 of adler"}}} {0x38 inData_1 W 0x0 "Data signal of inData" {{0 32 inData W 0 "Bit 31 to 0 of inData"}}} {0x3c inData_2 W 0x0 "Data signal of inData" {{0 32 inData W 0 "Bit 63 to 32 of inData"}}} {0x44 adler32Result_1 W 0x0 "Data signal of adler32Result" {{0 32 adler32Result W 0 "Bit 31 to 0 of adler32Result"}}} {0x48 adler32Result_2 W 0x0 "Data signal of adler32Result" {{0 32 adler32Result W 0 "Bit 63 to 32 of adler32Result"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"

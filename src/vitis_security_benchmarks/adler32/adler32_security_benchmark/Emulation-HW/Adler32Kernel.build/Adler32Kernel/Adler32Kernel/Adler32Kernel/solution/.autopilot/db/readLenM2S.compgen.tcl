...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outDataStrm_din { O 32 vector } outDataStrm_full_n { I 1 bit } outDataStrm_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_outData2Strm \
    op interface \
    ports { outData2Strm_din { O 32 vector } outData2Strm_full_n { I 1 bit } outData2Strm_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_outEndStrm \
    op interface \
    ports { outEndStrm_din { O 1 vector } outEndStrm_full_n { I 1 bit } outEndStrm_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_inData2 \
    op interface \
    ports { inData2_dout { I 64 vector } inData2_empty_n { I 1 bit } inData2_read { O 1 bit } } \
} "
}

...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_outDataStrm \
    op interface \
    ports { outDataStrm_din { O 512 vector } outDataStrm_full_n { I 1 bit } outDataStrm_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_inData \
    op interface \
    ports { inData_dout { I 64 vector } inData_empty_n { I 1 bit } inData_read { O 1 bit } } \
} "
}

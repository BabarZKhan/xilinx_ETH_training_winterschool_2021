...
set vpl_output_dir "/home/centos/workspace/adler32_security_benchmark/Emulation-HW/Adler32Kernel.build/link/int"
set input_dir "input"
set steps_log "../../link.steps.log"
set kernel_ip_dirs {
  {/home/centos/workspace/adler32_security_benchmark/Emulation-HW/Adler32Kernel.build/link/int/xo/ip_repo/xilinx_com_hls_Adler32Kernel_1_0}}
...
set config_info [dict create \
  ...
  aie_archive_file         "/home/centos/workspace/adler32_security_benchmark/Emulation-HW/Adler32Kernel.build/link/int/system.aieprj" \
...
set data_profile_Adler32Kernel_1_M_AXI_GMEM0 [dict create \
  port Adler32Kernel_1/M_AXI_GMEM0 \
  option all \
];
set data_profile_Adler32Kernel_1_M_AXI_GMEM1 [dict create \
  port Adler32Kernel_1/M_AXI_GMEM1 \
  option all \
];
set data_profile_Adler32Kernel_1_M_AXI_GMEM2 [dict create \
  port Adler32Kernel_1/M_AXI_GMEM2 \
  option all \
];
set data_profile_Adler32Kernel_1_M_AXI_GMEM3 [dict create \
  port Adler32Kernel_1/M_AXI_GMEM3 \
  option all \
];
set dict_profile [dict create \
  NAME profile_monitors \
  FIFO "8192" \
  DATA [list $data_profile_Adler32Kernel_1_M_AXI_GMEM0 $data_profile_Adler32Kernel_1_M_AXI_GMEM1 $data_profile_Adler32Kernel_1_M_AXI_GMEM2 $data_profile_Adler32Kernel_1_M_AXI_GMEM3] \
  STALL [list] \
  EXEC [list] \

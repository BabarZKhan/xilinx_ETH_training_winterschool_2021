...
################################################################
# This is a generated script based on design: bd_fa71
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./cl/cl.srcs/sources_1/bd/cl/ip/cl_aws_0_0/bd_0

...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_S06_AXI_ADDR_WIDTH {64} \
   CONFIG.C_S06_AXI_ARUSER_WIDTH {0} \
   CONFIG.C_S06_AXI_AWUSER_WIDTH {0} \
   CONFIG.C_S06_AXI_BUSER_WIDTH {0} \
   CONFIG.C_S06_AXI_DATA_WIDTH {512} \
   CONFIG.C_S06_AXI_HAS_BRESP {true} \
   CONFIG.C_S06_AXI_HAS_BURST {false} \
   CONFIG.C_S06_AXI_HAS_CACHE {true} \
   CONFIG.C_S06_AXI_HAS_LOCK {true} \
   CONFIG.C_S06_AXI_HAS_PROT {true} \
   CONFIG.C_S06_AXI_HAS_QOS {true} \
   CONFIG.C_S06_AXI_HAS_REGION {true} \
   CONFIG.C_S06_AXI_HAS_RRESP {true} \
   CONFIG.C_S06_AXI_HAS_WSTRB {true} \
   CONFIG.C_S06_AXI_ID_WIDTH {0} \
   CONFIG.C_S06_AXI_RUSER_WIDTH {0} \
   CONFIG.C_S06_AXI_WUSER_WIDTH {0} \
   CONFIG.C_S07_AXI_ADDR_WIDTH {64} \
   CONFIG.C_S07_AXI_ARUSER_WIDTH {0} \
   CONFIG.C_S07_AXI_AWUSER_WIDTH {0} \
   CONFIG.C_S07_AXI_BUSER_WIDTH {0} \
   CONFIG.C_S07_AXI_DATA_WIDTH {32} \
   CONFIG.C_S07_AXI_HAS_BRESP {true} \
   CONFIG.C_S07_AXI_HAS_BURST {false} \
   CONFIG.C_S07_AXI_HAS_CACHE {true} \
   CONFIG.C_S07_AXI_HAS_LOCK {true} \
   CONFIG.C_S07_AXI_HAS_PROT {true} \
   CONFIG.C_S07_AXI_HAS_QOS {true} \
   CONFIG.C_S07_AXI_HAS_REGION {true} \
   CONFIG.C_S07_AXI_HAS_RRESP {true} \
   CONFIG.C_S07_AXI_HAS_WSTRB {true} \
   CONFIG.C_S07_AXI_ID_WIDTH {0} \
   CONFIG.C_S07_AXI_RUSER_WIDTH {0} \
   CONFIG.C_S07_AXI_WUSER_WIDTH {0} \
  ...
  connect_bd_intf_net -intf_net S06_AXI_1 [get_bd_intf_ports S06_AXI] [get_bd_intf_pins xtlm_simple_intercon_0/S06_AXI]
  connect_bd_intf_net -intf_net S07_AXI_1 [get_bd_intf_ports S07_AXI] [get_bd_intf_pins xtlm_simple_intercon_0/S07_AXI]
  ...
  connect_bd_net -net aclk1_1 [get_bd_ports aclk1] [get_bd_pins xtlm_simple_intercon_0/s04_axi_aclk] [get_bd_pins xtlm_simple_intercon_0/s05_axi_aclk] [get_bd_pins xtlm_simple_intercon_0/s06_axi_aclk] [get_bd_pins xtlm_simple_intercon_0/s07_axi_aclk]
  ...
  assign_bd_address -offset 0x004000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S07_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x004000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S06_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x004000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S05_AXI] [get_bd_addr_segs M00_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x000400000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S07_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x000400000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S06_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x004800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S05_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x004800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S06_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x004800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S07_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x004C00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S05_AXI] [get_bd_addr_segs M03_AXI/Reg] -force
  assign_bd_address -offset 0x004C00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S06_AXI] [get_bd_addr_segs M03_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x004C00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces S07_AXI] [get_bd_addr_segs M03_AXI/Reg] -force

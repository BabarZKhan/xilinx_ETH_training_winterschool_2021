...
#---------------------------
# Instantiating Adler32Kernel_1
#---------------------------
set Adler32Kernel_1 [create_bd_cell -type ip -vlnv xilinx.com:hls:Adler32Kernel:1.0 Adler32Kernel_1]
  
set_property -dict [ list  \
  CONFIG.SLR_ASSIGNMENTS {SLR0}  ] $Adler32Kernel_1

#---------------------------
# Connectivity Phase 1
#---------------------------
connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /slr0/interconnect_axilite_user_0/M01_AXI] \
  [get_bd_intf_pins -auto_enable /Adler32Kernel_1/s_axi_control] \

connect_bd_net  \
  [get_bd_pins -auto_enable /kernel_clk/clk] \
  [get_bd_pins -auto_enable /slr0/interconnect_axilite_user_0/M01_ACLK] \
  [get_bd_pins -auto_enable /Adler32Kernel_1/ap_clk] \

connect_bd_net  \
  [get_bd_pins -auto_enable /slr0/psr_kernel_clk_0/interconnect_aresetn] \
  [get_bd_pins -auto_enable /slr0/interconnect_axilite_user_0/M01_ARESETN] \

connect_bd_net  \
  [get_bd_pins -auto_enable /slr0/psr_kernel_clk_0/peripheral_aresetn] \
  [get_bd_pins -auto_enable /Adler32Kernel_1/ap_rst_n] \
...
sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /Adler32Kernel_1/m_axi_gmem0] \
  [get_bd_cells /memory_subsystem] [list M00_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /Adler32Kernel_1/m_axi_gmem1] \
  [get_bd_cells /memory_subsystem] [list M00_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /Adler32Kernel_1/m_axi_gmem2] \
  [get_bd_cells /memory_subsystem] [list M00_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /Adler32Kernel_1/m_axi_gmem3] \
  [get_bd_cells /memory_subsystem] [list M00_AXI_MEM00]

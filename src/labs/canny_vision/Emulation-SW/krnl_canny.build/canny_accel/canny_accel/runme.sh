...
HD_PWD='/home/centos/workspace/canny_vision/Emulation-SW/krnl_canny.build/canny_accel/canny_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f canny_accel.tcl -messageDb vitis_hls.pb

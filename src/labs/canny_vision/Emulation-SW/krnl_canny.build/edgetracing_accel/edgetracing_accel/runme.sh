...
HD_PWD='/home/centos/workspace/canny_vision/Emulation-SW/krnl_canny.build/edgetracing_accel/edgetracing_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f edgetracing_accel.tcl -messageDb vitis_hls.pb

...
set vpl_output_dir "/home/centos/workspace/lab_optimization/Emulation-HW/binary_container_1.build/link/int"
set input_dir "input"
set steps_log "../../link.steps.log"
set kernel_ip_dirs {
  {/home/centos/workspace/lab_optimization/Emulation-HW/binary_container_1.build/link/int/xo/ip_repo/xilinx_com_hls_krnl_idct_1_0}}
...
set config_info [dict create \
  ...
  aie_archive_file         "/home/centos/workspace/lab_optimization/Emulation-HW/binary_container_1.build/link/int/system.aieprj" \
...
set data_profile_krnl_idct_1_M_AXI_GMEM0 [dict create \
  port krnl_idct_1/M_AXI_GMEM0 \
  option all \
];
set data_profile_krnl_idct_1_M_AXI_GMEM1 [dict create \
  port krnl_idct_1/M_AXI_GMEM1 \
  option all \
];
set data_profile_krnl_idct_1_M_AXI_GMEM2 [dict create \
  port krnl_idct_1/M_AXI_GMEM2 \
  option all \
];
set exec_profile_krnl_idct_1 [dict create \
  port krnl_idct_1 \
  option all \
];
set dict_profile [dict create \
  ...
  FIFO "8192" \
  DATA [list $data_profile_krnl_idct_1_M_AXI_GMEM0 $data_profile_krnl_idct_1_M_AXI_GMEM1 $data_profile_krnl_idct_1_M_AXI_GMEM2] \
  STALL [list] \
  EXEC [list $exec_profile_krnl_idct_1] \

...
entity krnl_idct_read_blocks_ap_uint_512_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of krnl_idct_read_blocks_ap_uint_512_s is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln223_reg_139 : STD_LOGIC_VECTOR (0 downto 0);
    signal iq4_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal icmp_ln223_reg_139_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal in_r_blk_n : STD_LOGIC;
    signal i_reg_85 : STD_LOGIC_VECTOR (1 downto 0);
    signal trunc_ln167_1_reg_128 : STD_LOGIC_VECTOR (57 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal icmp_ln223_fu_116_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln223_fu_122_p2 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal sext_ln167_fu_106_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state71)) then 
                i_reg_85 <= ap_const_lv2_0;
            elsif (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln223_fu_116_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                i_reg_85 <= add_ln223_fu_122_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln223_reg_139 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln223_reg_139 <= icmp_ln223_fu_116_p2;
                icmp_ln223_reg_139_pp0_iter1_reg <= icmp_ln223_reg_139;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (in_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                trunc_ln167_1_reg_128 <= in_r_dout(63 downto 6);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem1_ARREADY, in_r_empty_n, ap_CS_fsm_state2, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, icmp_ln223_fu_116_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln223_fu_116_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))) and not(((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln223_fu_116_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)))) then
    ...
    add_ln223_fu_122_p2 <= std_logic_vector(unsigned(i_reg_85) + unsigned(ap_const_lv2_1));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(m_axi_gmem1_RVALID, iq4_full_n, ap_enable_reg_pp0_iter1, icmp_ln223_reg_139, ap_enable_reg_pp0_iter2, icmp_ln223_reg_139_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_01001 <= (((icmp_ln223_reg_139_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (iq4_full_n = ap_const_logic_0)) or ((icmp_ln223_reg_139 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem1_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_gmem1_RVALID, iq4_full_n, ap_enable_reg_pp0_iter1, icmp_ln223_reg_139, ap_enable_reg_pp0_iter2, icmp_ln223_reg_139_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_11001 <= (((icmp_ln223_reg_139_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (iq4_full_n = ap_const_logic_0)) or ((icmp_ln223_reg_139 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem1_RVALID = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_gmem1_RVALID, iq4_full_n, ap_enable_reg_pp0_iter1, icmp_ln223_reg_139, ap_enable_reg_pp0_iter2, icmp_ln223_reg_139_pp0_iter1_reg)
    begin
                ap_block_pp0_stage0_subdone <= (((icmp_ln223_reg_139_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (iq4_full_n = ap_const_logic_0)) or ((icmp_ln223_reg_139 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_gmem1_RVALID = ap_const_logic_0)));
    end process;


    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, in_r_empty_n)
    begin
                ap_block_state1 <= ((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (in_r_empty_n = ap_const_logic_0));
    end process;

        ap_block_state72_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state73_pp0_stage0_iter1_assign_proc : process(m_axi_gmem1_RVALID, icmp_ln223_reg_139)
    begin
                ap_block_state73_pp0_stage0_iter1 <= ((icmp_ln223_reg_139 = ap_const_lv1_0) and (m_axi_gmem1_RVALID = ap_const_logic_0));
    end process;


    ap_block_state74_pp0_stage0_iter2_assign_proc : process(iq4_full_n, icmp_ln223_reg_139_pp0_iter1_reg)
    begin
                ap_block_state74_pp0_stage0_iter2 <= ((icmp_ln223_reg_139_pp0_iter1_reg = ap_const_lv1_0) and (iq4_full_n = ap_const_logic_0));
    end process;


    ap_condition_pp0_exit_iter0_state72_assign_proc : process(icmp_ln223_fu_116_p2)
    begin
        if ((icmp_ln223_fu_116_p2 = ap_const_lv1_1)) then 
    ...
    ap_int_blocking_cur_n <= (iq4_blk_n and in_r_blk_n);
    ...
    gmem1_blk_n_R_assign_proc : process(m_axi_gmem1_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln223_reg_139)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln223_reg_139 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    icmp_ln223_fu_116_p2 <= "1" when (i_reg_85 = ap_const_lv2_2) else "0";
    ...
    in_r_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, in_r_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (in_r_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    iq4_blk_n_assign_proc : process(iq4_full_n, ap_block_pp0_stage0, ap_enable_reg_pp0_iter2, icmp_ln223_reg_139_pp0_iter1_reg)
    begin
        if (((icmp_ln223_reg_139_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            iq4_blk_n <= iq4_full_n;
        else 
            iq4_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    iq4_din <= gmem1_addr_read_reg_148;

    iq4_write_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln223_reg_139_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln223_reg_139_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            iq4_write <= ap_const_logic_1;
        else 
            iq4_write <= ap_const_logic_0;
        end if; 
    end process;

    m_axi_gmem1_ARADDR <= sext_ln167_fu_106_p1;
    ...
    m_axi_gmem1_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln223_reg_139, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln223_reg_139 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    m_axi_gmem1_WVALID <= ap_const_logic_0;
        sext_ln167_fu_106_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln167_1_reg_128),64));

...
entity krnl_idct_write_blocks is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of krnl_idct_write_blocks is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln297_1_reg_178 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln297_1_reg_178_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem2_blk_n_B : STD_LOGIC;
    signal ap_CS_fsm_state73 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state73 : signal is "none";
    signal icmp_ln297_reg_163 : STD_LOGIC_VECTOR (0 downto 0);
    signal in_r_blk_n : STD_LOGIC;
    signal ap_CS_fsm_pp0_stage0 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage0 : signal is "none";
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal voutp_blk_n : STD_LOGIC;
    signal blocks_blk_n : STD_LOGIC;
    signal i_reg_101 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul_i_i_fu_112_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul_i_i_reg_157 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal icmp_ln297_fu_120_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln_reg_167 : STD_LOGIC_VECTOR (57 downto 0);
    signal icmp_ln297_1_fu_146_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state3_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state4_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state5_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_state5_io : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal add_ln297_fu_151_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal in_read_reg_187 : STD_LOGIC_VECTOR (511 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state3 : STD_LOGIC;
    signal sext_ln297_fu_136_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not(((icmp_ln297_reg_163 = ap_const_lv1_0) and (m_axi_gmem2_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((m_axi_gmem2_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                i_reg_101 <= ap_const_lv32_0;
            elsif (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln297_1_fu_146_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                i_reg_101 <= add_ln297_fu_151_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln297_1_reg_178 <= icmp_ln297_1_fu_146_p2;
                icmp_ln297_1_reg_178_pp0_iter1_reg <= icmp_ln297_1_reg_178;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (blocks_empty_n = ap_const_logic_0) or (voutp_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                icmp_ln297_reg_163 <= icmp_ln297_fu_120_p2;
                    mul_i_i_reg_157(31 downto 1) <= mul_i_i_fu_112_p3(31 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln297_1_reg_178 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                in_read_reg_187 <= in_r_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (blocks_empty_n = ap_const_logic_0) or (voutp_empty_n = ap_const_logic_0))) and (icmp_ln297_fu_120_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                trunc_ln_reg_167 <= voutp_dout(63 downto 6);
            end if;
        end if;
    end process;
    mul_i_i_reg_157(0) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem2_AWREADY, m_axi_gmem2_BVALID, voutp_empty_n, blocks_empty_n, ap_CS_fsm_state2, ap_enable_reg_pp0_iter2, ap_CS_fsm_state73, icmp_ln297_reg_163, ap_enable_reg_pp0_iter1, icmp_ln297_fu_120_p2, icmp_ln297_1_fu_146_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (blocks_empty_n = ap_const_logic_0) or (voutp_empty_n = ap_const_logic_0))) and (icmp_ln297_fu_120_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state73;
                elsif ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (blocks_empty_n = ap_const_logic_0) or (voutp_empty_n = ap_const_logic_0))) and (icmp_ln297_fu_120_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln297_1_fu_146_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) and not(((ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln297_1_fu_146_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone)))) then
            ...
            when ap_ST_fsm_state73 => 
                if ((not(((icmp_ln297_reg_163 = ap_const_lv1_0) and (m_axi_gmem2_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state73;
                end if;
    ...
    add_ln297_fu_151_p2 <= std_logic_vector(unsigned(i_reg_101) + unsigned(ap_const_lv32_1));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(in_r_empty_n, icmp_ln297_1_reg_178, ap_enable_reg_pp0_iter1)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln297_1_reg_178 = ap_const_lv1_0) and (in_r_empty_n = ap_const_logic_0));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(in_r_empty_n, ap_enable_reg_pp0_iter2, icmp_ln297_1_reg_178, ap_enable_reg_pp0_iter1, ap_block_state5_io)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_const_boolean_1 = ap_block_state5_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln297_1_reg_178 = ap_const_lv1_0) and (in_r_empty_n = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(in_r_empty_n, ap_enable_reg_pp0_iter2, icmp_ln297_1_reg_178, ap_enable_reg_pp0_iter1, ap_block_state5_io)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_const_boolean_1 = ap_block_state5_io) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln297_1_reg_178 = ap_const_lv1_0) and (in_r_empty_n = ap_const_logic_0)));
    end process;


    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, voutp_empty_n, blocks_empty_n)
    begin
                ap_block_state1 <= ((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (blocks_empty_n = ap_const_logic_0) or (voutp_empty_n = ap_const_logic_0));
    end process;

        ap_block_state3_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state4_pp0_stage0_iter1_assign_proc : process(in_r_empty_n, icmp_ln297_1_reg_178)
    begin
                ap_block_state4_pp0_stage0_iter1 <= ((icmp_ln297_1_reg_178 = ap_const_lv1_0) and (in_r_empty_n = ap_const_logic_0));
    end process;


    ap_block_state5_io_assign_proc : process(m_axi_gmem2_WREADY, icmp_ln297_1_reg_178_pp0_iter1_reg)
    begin
                ap_block_state5_io <= ((icmp_ln297_1_reg_178_pp0_iter1_reg = ap_const_lv1_0) and (m_axi_gmem2_WREADY = ap_const_logic_0));
    end process;

        ap_block_state5_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state73_assign_proc : process(m_axi_gmem2_BVALID, icmp_ln297_reg_163)
    begin
                ap_block_state73 <= ((icmp_ln297_reg_163 = ap_const_lv1_0) and (m_axi_gmem2_BVALID = ap_const_logic_0));
    end process;


    ap_condition_pp0_exit_iter0_state3_assign_proc : process(icmp_ln297_1_fu_146_p2)
    begin
        if ((icmp_ln297_1_fu_146_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, m_axi_gmem2_BVALID, ap_CS_fsm_state73, icmp_ln297_reg_163)
    begin
        if ((not(((icmp_ln297_reg_163 = ap_const_lv1_0) and (m_axi_gmem2_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    ap_int_blocking_cur_n <= (voutp_blk_n and in_r_blk_n and blocks_blk_n);
    ap_int_blocking_n <= (ap_int_blocking_cur_n and ap_const_logic_1);

    ap_ready_assign_proc : process(m_axi_gmem2_BVALID, ap_CS_fsm_state73, icmp_ln297_reg_163)
    begin
        if ((not(((icmp_ln297_reg_163 = ap_const_lv1_0) and (m_axi_gmem2_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    blocks_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, voutp_empty_n, blocks_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (blocks_empty_n = ap_const_logic_0) or (voutp_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    gmem2_blk_n_B_assign_proc : process(m_axi_gmem2_BVALID, ap_CS_fsm_state73, icmp_ln297_reg_163)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln297_reg_163 = ap_const_lv1_0))) then 
    ...
    gmem2_blk_n_W_assign_proc : process(m_axi_gmem2_WREADY, ap_enable_reg_pp0_iter2, ap_block_pp0_stage0, icmp_ln297_1_reg_178_pp0_iter1_reg)
    begin
        if (((icmp_ln297_1_reg_178_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    icmp_ln297_1_fu_146_p2 <= "1" when (i_reg_101 = mul_i_i_reg_157) else "0";
    icmp_ln297_fu_120_p2 <= "1" when (blocks_dout = ap_const_lv31_0) else "0";

    in_r_blk_n_assign_proc : process(in_r_empty_n, ap_block_pp0_stage0, icmp_ln297_1_reg_178, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln297_1_reg_178 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    in_r_read_assign_proc : process(icmp_ln297_1_reg_178, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln297_1_reg_178 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    m_axi_gmem2_BREADY_assign_proc : process(m_axi_gmem2_BVALID, ap_CS_fsm_state73, icmp_ln297_reg_163)
    begin
        if ((not(((icmp_ln297_reg_163 = ap_const_lv1_0) and (m_axi_gmem2_BVALID = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state73) and (icmp_ln297_reg_163 = ap_const_lv1_0))) then 
    ...
    m_axi_gmem2_WDATA <= in_read_reg_187;
    ...
    m_axi_gmem2_WVALID_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln297_1_reg_178_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln297_1_reg_178_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    mul_i_i_fu_112_p3 <= (blocks_dout & ap_const_lv1_0);
        sext_ln297_fu_136_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_reg_167),64));


    voutp_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, voutp_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            voutp_blk_n <= voutp_empty_n;
        else 
            voutp_blk_n <= ap_const_logic_1;
        end if; 
    end process;


    voutp_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, voutp_empty_n, blocks_empty_n)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start = ap_const_logic_0) or (blocks_empty_n = ap_const_logic_0) or (voutp_empty_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            voutp_read <= ap_const_logic_1;
        else 
            voutp_read <= ap_const_logic_0;
        end if; 
    end process;

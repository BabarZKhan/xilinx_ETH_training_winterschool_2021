...
input   in_r_empty_n;
output   in_r_read;
input  [63:0] voutp_dout;
input   voutp_empty_n;
output   voutp_read;
input  [30:0] blocks_dout;
...
reg   [0:0] icmp_ln297_1_reg_178;
reg   [0:0] icmp_ln297_1_reg_178_pp0_iter1_reg;
reg    gmem2_blk_n_B;
wire    ap_CS_fsm_state73;
reg   [0:0] icmp_ln297_reg_163;
reg    in_r_blk_n;
...
reg    blocks_blk_n;
reg   [31:0] i_reg_101;
wire   [31:0] mul_i_i_fu_112_p3;
reg   [31:0] mul_i_i_reg_157;
reg    ap_block_state1;
wire   [0:0] icmp_ln297_fu_120_p2;
reg   [57:0] trunc_ln_reg_167;
wire   [0:0] icmp_ln297_1_fu_146_p2;
wire    ap_block_state3_pp0_stage0_iter0;
reg    ap_block_state4_pp0_stage0_iter1;
wire    ap_block_state5_pp0_stage0_iter2;
reg    ap_block_state5_io;
reg    ap_block_pp0_stage0_11001;
wire   [31:0] add_ln297_fu_151_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [511:0] in_read_reg_187;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
wire  signed [63:0] sext_ln297_fu_136_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((icmp_ln297_reg_163 == 1'd0) & (m_axi_gmem2_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((m_axi_gmem2_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        i_reg_101 <= 32'd0;
    end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln297_1_fu_146_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (blocks_empty_n == 1'b0) | (voutp_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        icmp_ln297_reg_163 <= icmp_ln297_fu_120_p2;
        mul_i_i_reg_157[31 : 1] <= mul_i_i_fu_112_p3[31 : 1];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln297_1_reg_178 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        in_read_reg_187 <= in_r_dout;
    end
end

always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (blocks_empty_n == 1'b0) | (voutp_empty_n == 1'b0)) & (icmp_ln297_fu_120_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        trunc_ln_reg_167 <= {{voutp_dout[63:6]}};
    end
end

always @ (*) begin
    if ((icmp_ln297_1_fu_146_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((~((icmp_ln297_reg_163 == 1'd0) & (m_axi_gmem2_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state73) & (icmp_ln297_reg_163 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln297_1_reg_178_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln297_1_reg_178 == 1'd0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln297_1_reg_178 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        in_r_read = 1'b1;
    end else begin
        in_r_read = 1'b0;
    end
...
always @ (*) begin
    if ((~((icmp_ln297_reg_163 == 1'd0) & (m_axi_gmem2_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state73) & (icmp_ln297_reg_163 == 1'd0))) begin
...
always @ (*) begin
    if (((icmp_ln297_1_reg_178_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (blocks_empty_n == 1'b0) | (voutp_empty_n == 1'b0)) & (icmp_ln297_fu_120_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
                ap_NS_fsm = ap_ST_fsm_state73;
            end else if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (blocks_empty_n == 1'b0) | (voutp_empty_n == 1'b0)) & (icmp_ln297_fu_120_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln297_1_fu_146_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln297_1_fu_146_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
assign add_ln297_fu_151_p2 = (i_reg_101 + 32'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln297_1_reg_178 == 1'd0) & (in_r_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln297_1_reg_178 == 1'd0) & (in_r_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln297_1_reg_178 == 1'd0) & (in_r_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (blocks_empty_n == 1'b0) | (voutp_empty_n == 1'b0));
end

assign ap_block_state3_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln297_1_reg_178 == 1'd0) & (in_r_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln297_1_reg_178_pp0_iter1_reg == 1'd0) & (m_axi_gmem2_WREADY == 1'b0));
end

assign ap_block_state5_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state73 = ((icmp_ln297_reg_163 == 1'd0) & (m_axi_gmem2_BVALID == 1'b0));
end
...
assign ap_int_blocking_cur_n = (voutp_blk_n & in_r_blk_n & blocks_blk_n);

assign ap_int_blocking_n = (ap_int_blocking_cur_n & 1'b1);

assign ap_str_blocking_n = (1'b1 & 1'b1);

assign icmp_ln297_1_fu_146_p2 = ((i_reg_101 == mul_i_i_reg_157) ? 1'b1 : 1'b0);

assign icmp_ln297_fu_120_p2 = ((blocks_dout == 31'd0) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_AWADDR = sext_ln297_fu_136_p1;
...
assign m_axi_gmem2_AWLEN = mul_i_i_reg_157;
...
assign m_axi_gmem2_WDATA = in_read_reg_187;
...
assign mul_i_i_fu_112_p3 = {{blocks_dout}, {1'd0}};

assign sext_ln297_fu_136_p1 = $signed(trunc_ln_reg_167);

always @ (posedge ap_clk) begin
    mul_i_i_reg_157[0] <= 1'b0;
end

endmodule //krnl_idct_write_blocks

...
set Library     "hls"
set IPName      "krnl_idct"
set Version     "1.0"
set DisplayName "Krnl_idct"
set Revision    "2101142111"
...
set xo_kernel_name "krnl_idct"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/centos/workspace/lab_optimization/Emulation-HW/binary_container_1.build/krnl_idct/krnl_idct/krnl_idct/solution"
set debug_dir "/home/centos/workspace/lab_optimization/Emulation-HW/binary_container_1.build/krnl_idct/krnl_idct/krnl_idct/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {krnl_idct_mul_11ns_32s_32_2_1
...
krnl_idct_fifo_w64_d2_S
krnl_idct_fifo_w64_d2_S
krnl_idct_fifo_w64_d4_S
krnl_idct_fifo_w32_d2_S
krnl_idct_fifo_w31_d2_S
krnl_idct_fifo_w32_d3_S
krnl_idct_fifo_w512_d2_S
krnl_idct_fifo_w512_d512_A
krnl_idct_fifo_w1_d2_S
krnl_idct_fifo_w512_d512_A
krnl_idct_fifo_w31_d2_S
krnl_idct_start_for_krnl_idct_dataflow_Block_split25_proc_U0
krnl_idct_start_for_write_blocks_U0
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 block_r_1 W 0x0 "Data signal of block_r" {{0 32 block_r W 0 "Bit 31 to 0 of block_r"}}} {0x14 block_r_2 W 0x0 "Data signal of block_r" {{0 32 block_r W 0 "Bit 63 to 32 of block_r"}}} {0x1c q_1 W 0x0 "Data signal of q" {{0 32 q W 0 "Bit 31 to 0 of q"}}} {0x20 q_2 W 0x0 "Data signal of q" {{0 32 q W 0 "Bit 63 to 32 of q"}}} {0x28 voutp_1 W 0x0 "Data signal of voutp" {{0 32 voutp W 0 "Bit 31 to 0 of voutp"}}} {0x2c voutp_2 W 0x0 "Data signal of voutp" {{0 32 voutp W 0 "Bit 63 to 32 of voutp"}}} {0x34 ignore_dc W 0x0 "Data signal of ignore_dc" {{0 32 ignore_dc W 0 "Bit 31 to 0 of ignore_dc"}}} {0x3c blocks W 0x0 "Data signal of blocks" {{0 32 blocks W 0 "Bit 31 to 0 of blocks"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 2145 II x}

...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_iq4 \
    op interface \
    ports { iq4_din { O 512 vector } iq4_full_n { I 1 bit } iq4_write { O 1 bit } } \
} "
}

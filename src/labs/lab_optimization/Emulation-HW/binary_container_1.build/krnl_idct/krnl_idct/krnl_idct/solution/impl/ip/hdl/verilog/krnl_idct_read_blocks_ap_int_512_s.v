...
module krnl_idct_read_blocks_ap_int_512_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input   out_r_full_n;
output   out_r_write;
input  [63:0] block_r_dout;
input   block_r_empty_n;
output   block_r_read;
...
reg   [0:0] icmp_ln223_1_reg_171;
reg    out_r_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln223_1_reg_171_pp0_iter1_reg;
reg    block_r_blk_n;
reg    blocks_blk_n;
reg   [31:0] i_reg_94;
wire   [31:0] mul_i_i_fu_105_p3;
reg   [31:0] mul_i_i_reg_150;
reg    ap_block_state1;
wire   [0:0] icmp_ln223_fu_113_p2;
reg   [57:0] trunc_ln_reg_160;
wire   [0:0] icmp_ln223_1_fu_139_p2;
wire    ap_block_state72_pp0_stage0_iter0;
reg    ap_block_state73_pp0_stage0_iter1;
reg    ap_block_state74_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
wire   [31:0] add_ln223_fu_144_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [511:0] gmem0_addr_read_reg_180;
wire    ap_CS_fsm_state71;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state72;
wire  signed [63:0] sext_ln223_fu_129_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state71)) begin
        i_reg_94 <= 32'd0;
    end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln223_1_fu_139_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_reg_94 <= add_ln223_fu_144_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln223_1_reg_171 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (blocks_empty_n == 1'b0) | (block_r_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        mul_i_i_reg_150[31 : 1] <= mul_i_i_fu_105_p3[31 : 1];
    end
end

always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (blocks_empty_n == 1'b0) | (block_r_empty_n == 1'b0)) & (icmp_ln223_fu_113_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        trunc_ln_reg_160 <= {{block_r_dout[63:6]}};
    end
end

always @ (*) begin
    if ((icmp_ln223_1_fu_139_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln223_1_reg_171 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln223_1_reg_171 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln223_1_reg_171_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln223_1_reg_171_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        out_r_write = 1'b1;
    end else begin
        out_r_write = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (blocks_empty_n == 1'b0) | (block_r_empty_n == 1'b0)) & (icmp_ln223_fu_113_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
                ap_NS_fsm = ap_ST_fsm_state75;
            end else if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (blocks_empty_n == 1'b0) | (block_r_empty_n == 1'b0)) & (icmp_ln223_fu_113_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln223_1_fu_139_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln223_1_fu_139_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_state75;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end
...
assign add_ln223_fu_144_p2 = (i_reg_94 + 32'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln223_1_reg_171_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (out_r_full_n == 1'b0)) | ((icmp_ln223_1_reg_171 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem0_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln223_1_reg_171_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (out_r_full_n == 1'b0)) | ((icmp_ln223_1_reg_171 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem0_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln223_1_reg_171_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (out_r_full_n == 1'b0)) | ((icmp_ln223_1_reg_171 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_gmem0_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (blocks_empty_n == 1'b0) | (block_r_empty_n == 1'b0));
end

assign ap_block_state72_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state73_pp0_stage0_iter1 = ((icmp_ln223_1_reg_171 == 1'd0) & (m_axi_gmem0_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state74_pp0_stage0_iter2 = ((icmp_ln223_1_reg_171_pp0_iter1_reg == 1'd0) & (out_r_full_n == 1'b0));
end
...
assign ap_int_blocking_cur_n = (out_r_blk_n & blocks_blk_n & block_r_blk_n);

assign ap_int_blocking_n = (ap_int_blocking_cur_n & 1'b1);

assign ap_str_blocking_n = (1'b1 & 1'b1);

assign icmp_ln223_1_fu_139_p2 = ((i_reg_94 == mul_i_i_reg_150) ? 1'b1 : 1'b0);

assign icmp_ln223_fu_113_p2 = ((blocks_dout == 31'd0) ? 1'b1 : 1'b0);

assign m_axi_gmem0_ARADDR = sext_ln223_fu_129_p1;
...
assign m_axi_gmem0_ARLEN = mul_i_i_reg_150;
...
assign mul_i_i_fu_105_p3 = {{blocks_dout}, {1'd0}};

assign out_r_din = gmem0_addr_read_reg_180;

assign sext_ln223_fu_129_p1 = $signed(trunc_ln_reg_160);

always @ (posedge ap_clk) begin
    mul_i_i_reg_150[0] <= 1'b0;
end

endmodule //krnl_idct_read_blocks_ap_int_512_s

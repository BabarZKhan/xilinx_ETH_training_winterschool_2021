set moduleName read_blocks_ap_int_512_s
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "block_r", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ block_r_dout sc_in sc_lv 64 signal 2 } 
	{ block_r_empty_n sc_in sc_logic 1 signal 2 } 
	{ block_r_read sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "block_r_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "block_r", "role": "dout" }} , 
 	{ "name": "block_r_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "block_r", "role": "empty_n" }} , 
 	{ "name": "block_r_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "block_r", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "out_r", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "512",
				"BlockSignal" : [
					{"Name" : "out_r_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "block_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "2121"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "2121"}
]}
...
set Spec2ImplPortList { 
	...
	out_r { ap_fifo {  { out_r_din fifo_data 1 512 }  { out_r_full_n fifo_status 0 1 }  { out_r_write fifo_update 1 1 } } }
	block_r { ap_fifo {  { block_r_dout fifo_data 0 64 }  { block_r_empty_n fifo_status 0 1 }  { block_r_read fifo_update 1 1 } } }

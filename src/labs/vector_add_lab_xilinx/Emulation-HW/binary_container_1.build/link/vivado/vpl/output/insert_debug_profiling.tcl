...
set dpa_dict [list \
              ...
              [get_bd_intf_pins krnl_vadd_1/m_axi_gmem]  {TYPE data DETAIL all CLK_SRC /krnl_vadd_1/ap_clk RST_SRC /krnl_vadd_1/ap_rst_n MEMORY {{DDR[1]}} PRINTABLE_KEY {[get_bd_intf_pins krnl_vadd_1/m_axi_gmem]} INS_MODE user} \
             ]
set dpa_opts [list \
...
set_param bd.debug_profile.script /home/centos/workspace/vector_add_lab_xilinx/Emulation-HW/binary_container_1.build/link/vivado/vpl/.local/debug_profile_automation.tcl
...
assign_bd_address
debug_profile::write_debug_ip_layout true "xilinx:aws-vu9p-f1:shell-v04261818:201920.2" "/home/centos/workspace/vector_add_lab_xilinx/Emulation-HW/binary_container_1.build/link/int"

...
proc create_hier_cell_slr1 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net interconnect_axilite_1_M00_AXI [get_bd_intf_pins M00_AXI2] [get_bd_intf_pins interconnect_axilite_user_1/M00_AXI]
  ...
  connect_bd_net -net ext_reset_in_1_1 [get_bd_pins dma_pcie_arst] [get_bd_pins interconnect_axilite_user_1/ARESETN] [get_bd_pins interconnect_axilite_user_1/M00_ARESETN] [get_bd_pins interconnect_axilite_user_1/S00_ARESETN]
  connect_bd_net -net ext_reset_in_2_1 [get_bd_pins ext_reset_in1] [get_bd_pins psr_kernel2_clk_1/ext_reset_in]
  connect_bd_net -net psr_kernel_clk_1_interconnect_aresetn [get_bd_pins interconnect_axilite_user_1/M01_ARESETN] [get_bd_pins psr_kernel_clk_1/interconnect_aresetn]
  ...
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins slowest_sync_clk] [get_bd_pins interconnect_axilite_user_1/M01_ACLK] [get_bd_pins psr_kernel_clk_1/slowest_sync_clk]
  connect_bd_net -net slowest_sync_clk_1_1 [get_bd_pins dma_pcie_aclk] [get_bd_pins interconnect_axilite_user_1/ACLK] [get_bd_pins interconnect_axilite_user_1/M00_ACLK] [get_bd_pins interconnect_axilite_user_1/S00_ACLK]
...
proc create_hier_cell_System_DPA { parentCell nameHier } {
  ...
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/krnl_vadd_1} [get_bd_cells /System_DPA/dpa_mon0]
  ...
  set_property -dict [ list \
   ...
   CONFIG.MONITOR_ID {krnl_vadd_1:m_axi_gmem-DDR[1]} \
   CONFIG.TRACE_READ_ID {0} \
   CONFIG.TRACE_WRITE_ID {1} \
 ] $dpa_mon1
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/krnl_vadd_1/m_axi_gmem-DDR[1]} [get_bd_cells /System_DPA/dpa_mon1]
  ...
  connect_bd_intf_net -intf_net krnl_vadd_1_m_axi_gmem [get_bd_intf_pins MON_M_AXI] [get_bd_intf_pins dpa_mon1/MON_M_AXI]
  ...
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins trace_clk] [get_bd_pins dpa_ctrl_interconnect/M00_ACLK] [get_bd_pins dpa_ctrl_interconnect/M01_ACLK] [get_bd_pins dpa_ctrl_interconnect/M02_ACLK] [get_bd_pins dpa_ctrl_interconnect/M03_ACLK] [get_bd_pins dpa_hub/axilite_clk] [get_bd_pins dpa_hub/trace_clk] [get_bd_pins dpa_mon0/mon_clk] [get_bd_pins dpa_mon0/trace_clk] [get_bd_pins dpa_mon1/mon_clk] [get_bd_pins dpa_mon1/trace_clk]
  ...
  connect_bd_net -net slr1_peripheral_aresetn [get_bd_pins trace_rst] [get_bd_pins dpa_ctrl_interconnect/M00_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M01_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M02_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M03_ARESETN] [get_bd_pins dpa_hub/axilite_aresetn] [get_bd_pins dpa_hub/trace_aresetn] [get_bd_pins dpa_mon0/mon_resetn] [get_bd_pins dpa_mon0/trace_rst] [get_bd_pins dpa_mon1/mon_resetn] [get_bd_pins dpa_mon1/trace_rst]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: krnl_vadd_1, and set properties
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins System_DPA/S00_AXI] [get_bd_intf_pins slr1/M00_AXI2]
  ...
  connect_bd_intf_net -intf_net krnl_vadd_1_m_axi_gmem [get_bd_intf_pins krnl_vadd_1/m_axi_gmem] [get_bd_intf_pins memory_subsystem/S04_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets krnl_vadd_1_m_axi_gmem] [get_bd_intf_pins System_DPA/MON_M_AXI] [get_bd_intf_pins memory_subsystem/S04_AXI]
  ...
  connect_bd_intf_net -intf_net slr1_M01_AXI [get_bd_intf_pins krnl_vadd_1/s_axi_control] [get_bd_intf_pins slr1/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M01_AXI] [get_bd_intf_pins System_DPA/MON_S_AXI] [get_bd_intf_pins slr1/M01_AXI]
  ...
  connect_bd_net -net krnl_vadd_1_interrupt [get_bd_pins interrupt_concat/In0] [get_bd_pins krnl_vadd_1/interrupt]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins System_DPA/trace_clk] [get_bd_pins kernel_clk/clk] [get_bd_pins krnl_vadd_1/ap_clk] [get_bd_pins memory_subsystem/aclk1] [get_bd_pins slr0/slowest_sync_clk] [get_bd_pins slr1/slowest_sync_clk] [get_bd_pins slr2/slowest_sync_clk]
  ...
  connect_bd_net -net slr1_peripheral_aresetn [get_bd_pins System_DPA/trace_rst] [get_bd_pins krnl_vadd_1/ap_rst_n] [get_bd_pins slr1/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/M01_AXI_MEM00] -force
  ...
  assign_bd_address -offset 0x1D040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs krnl_vadd_1/s_axi_control/Reg] -force
  ...
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces krnl_vadd_1/Data_m_axi_gmem] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM02]

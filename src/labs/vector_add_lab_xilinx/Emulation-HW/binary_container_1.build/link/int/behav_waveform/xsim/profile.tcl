...
set readBusySignals { /emu_wrapper/emu_i/dynamic_region/krnl_vadd_1/m_axi_gmem.readActive }
set writeBusySignals { /emu_wrapper/emu_i/dynamic_region/krnl_vadd_1/m_axi_gmem.writeActive }

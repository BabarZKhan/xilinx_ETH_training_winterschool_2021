# 1 "/home/centos/workspace/improving_performance_lab/src/wide_vadd_krnl.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/centos/workspace/improving_performance_lab/src/wide_vadd_krnl.cpp" 2
# 39 "/home/centos/workspace/improving_performance_lab/src/wide_vadd_krnl.cpp"
...
# 40 "/home/centos/workspace/improving_performance_lab/src/wide_vadd_krnl.cpp" 2
...
# 41 "/home/centos/workspace/improving_performance_lab/src/wide_vadd_krnl.cpp" 2
...
# 42 "/home/centos/workspace/improving_performance_lab/src/wide_vadd_krnl.cpp" 2
...
const unsigned int c_chunk_sz = 64;
const unsigned int c_size = (512 / 32);
# 60 "/home/centos/workspace/improving_performance_lab/src/wide_vadd_krnl.cpp"
extern "C"
{
    __attribute__((sdx_kernel("wide_vadd", 0))) void wide_vadd(
    ...
    {
#pragma HLS TOP name=wide_vadd
# 68 "/home/centos/workspace/improving_performance_lab/src/wide_vadd_krnl.cpp"
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
 ...
 uint512_dt v1_local[64];
        uint512_dt v2_local[64];
        uint512_dt result_local[64];




        int size_in16 = (size - 1) / (512 / 32) + 1;


        VITIS_LOOP_88_1: for (int i = 0; i < size_in16; i += 64) {
...
#pragma HLS LOOP_TRIPCOUNT min = 1 max = 64
 uint512_dt tmpV1 = v1_local[j];
                ...
                uint512_dt tmpV3 = 0;
                vec_sum: for (unsigned int s = 0; s < 512; s+= 32){
#pragma HLS unroll

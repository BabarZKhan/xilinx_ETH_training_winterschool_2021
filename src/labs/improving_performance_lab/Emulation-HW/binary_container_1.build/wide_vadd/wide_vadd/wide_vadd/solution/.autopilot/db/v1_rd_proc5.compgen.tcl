...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { v1_local_V1_din { O 512 vector } v1_local_V1_full_n { I 1 bit } v1_local_V1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { v2_local_V2_din { O 512 vector } v2_local_V2_full_n { I 1 bit } v2_local_V2_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_i_out \
    op interface \
    ports { i_out_din { O 64 vector } i_out_full_n { I 1 bit } i_out_write { O 1 bit } } \
} "
}

...
# FIFO definition:
set ID 19
set FifoName wide_vadd_fifo_w512_d64_A
set InstName v1_local_V_U
...
# FIFO definition:
set ID 21
set FifoName wide_vadd_fifo_w64_d2_S
set InstName i_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
...
# FIFO definition:
set ID 22
set FifoName wide_vadd_fifo_w32_d2_S
...
# FIFO definition:
set ID 24
set FifoName wide_vadd_start_for_v2_rd_add_proc_U0
set InstName start_for_v2_rd_add_proc_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_i \
    op interface \
    ports { i { I 64 vector } i_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_size \
    op interface \
    ports { size { I 32 vector } size_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_in1 \
    op interface \
    ports { in1 { I 64 vector } in1_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_in2 \
    op interface \
    ports { in2 { I 64 vector } in2_ap_vld { I 1 bit } } \
} "
}

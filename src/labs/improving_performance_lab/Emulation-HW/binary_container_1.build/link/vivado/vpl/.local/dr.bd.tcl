...
#---------------------------
# Instantiating wide_vadd_1
#---------------------------
set wide_vadd_1 [create_bd_cell -type ip -vlnv xilinx.com:hls:wide_vadd:1.0 wide_vadd_1]
  
set_property -dict [ list  \
  CONFIG.SLR_ASSIGNMENTS {SLR2}  ] $wide_vadd_1

#---------------------------
# Connectivity Phase 1
#---------------------------
connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /slr2/interconnect_axilite_user_2/M01_AXI] \
  [get_bd_intf_pins -auto_enable /wide_vadd_1/s_axi_control] \

connect_bd_net  \
  [get_bd_pins -auto_enable /kernel_clk/clk] \
  [get_bd_pins -auto_enable /slr2/interconnect_axilite_user_2/M01_ACLK] \
  [get_bd_pins -auto_enable /wide_vadd_1/ap_clk] \

connect_bd_net  \
  [get_bd_pins -auto_enable /slr2/psr_kernel_clk_2/interconnect_aresetn] \
  [get_bd_pins -auto_enable /slr2/interconnect_axilite_user_2/M01_ARESETN] \

connect_bd_net  \
  [get_bd_pins -auto_enable /slr2/psr_kernel_clk_2/peripheral_aresetn] \
  [get_bd_pins -auto_enable /wide_vadd_1/ap_rst_n] \
...
sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /wide_vadd_1/m_axi_gmem] \
  [get_bd_cells /memory_subsystem] [list M01_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /wide_vadd_1/m_axi_gmem1] \
  [get_bd_cells /memory_subsystem] [list M01_AXI_MEM00]

sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /wide_vadd_1/m_axi_gmem2] \
  [get_bd_cells /memory_subsystem] [list M01_AXI_MEM00]

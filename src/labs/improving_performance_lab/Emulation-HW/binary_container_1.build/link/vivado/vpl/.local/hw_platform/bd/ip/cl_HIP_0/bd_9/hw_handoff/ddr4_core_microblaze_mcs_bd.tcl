...
################################################################
# This is a generated script based on design: bd_d017
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./cl/cl.srcs/sources_1/bd/cl/ip/cl_HIP_0/bd_9
